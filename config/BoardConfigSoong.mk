...
SOONG_CONFIG_calyxGlobalVars_sdmcore_has_is_display_hw_available_func := $(TARGET_SDMCORE_HAS_IS_DISPLAY_HW_AVAILABLE_FUNC)
...
SOONG_CONFIG_calyxGlobalVars_aapt_version_code := $(shell date -u +%Y%m%d)
