...
for k in releasekey platform shared media networkstack com.android.connectivity.resources com.android.hotspot2.osulogin com.android.wifi.resources com.android.adservices.api com.android.bluetooth; do
	if [[ ! -e ${k}.pk8 ]]; then
