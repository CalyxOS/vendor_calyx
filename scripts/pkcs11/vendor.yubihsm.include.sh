...
export YUBIHSM_KEY_CAPABILITIES=${YUBIHSM_KEY_CAPABILITIES:-sign-pkcs,sign-pss,sign-ecdsa,sign-eddsa}
...
find_pkcs11_module() {
  ...
  local -a possible_paths=(
    /usr{/local,}/lib{/x86_64-linux-gnu,/aarch64-linux-gnu,64,}{/pkcs11,}/yubihsm_pkcs11.so
  )
