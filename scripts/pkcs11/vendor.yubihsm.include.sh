...
yubihsm() {
  ...
  # Due to the capture method used, we need to filter it out again in the stderr variable.
  stderr=$(printf "%s\n" "$stderr" | yubihsm_spam_filter)
...
## Debugging object presence after each command...
