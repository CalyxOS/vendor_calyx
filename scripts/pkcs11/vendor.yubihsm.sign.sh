...
parallel -j 7 --tag --line-buffer ./vendor/calyx/scripts/pkcs11/vendor.yubihsm.release.sh {} calyx_{}-target_files-25608200.zip ::: akita shiba bluejay &p1=$!
parallel -j 7 --tag --line-buffer ./vendor/calyx/scripts/pkcs11/vendor.yubihsm.release.sh {} calyx_{}-target_files-25608210.zip ::: FP5 hawao &p2=$!
