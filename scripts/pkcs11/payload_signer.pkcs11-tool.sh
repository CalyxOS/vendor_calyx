...
echo "         Its use is not recommended. Please set SIGNING_HELPER_TOOL=openssl." >&2
echo "         If you use it anyway, its output will be checked against that of openssl." >&2
...
main() {
  ...
  id_and_rsa_key_size=$(get_id_and_rsa_key_size_for_key "$key")
